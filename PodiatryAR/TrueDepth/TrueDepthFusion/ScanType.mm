...
{
    BOOL success = YES;
    NSString *plyFilename = [NSString stringWithFormat:@"Scan-%@.ply", [ScanType stringFromDate:_dateCreated]];
...
@implementation ScanType (Compression)
